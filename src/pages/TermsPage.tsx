...
const TermsPage = () => (
  <>
    <Helmet>
      <title>利用規約 - AI相談メーカー | サービス利用条件</title>
      <meta
        name="description"
        content="AI相談メーカーの利用規約。サービスの利用条件、禁止事項、免責事項について詳しく説明しています。"
      />
      <meta
        name="keywords"
        content="利用規約, 利用条件, AI相談, サービス規約, 利用条項"
      />
      <meta name="robots" content="index, follow" />
      <link rel="canonical" href="https://ai-consultation.netlify.app/terms" />
    </Helmet>
    ...
    <StructuredData
      ...
      data={{
        title: "利用規約 - AI相談メーカー",
        description:
          "AI相談メーカーの利用規約。サービスの利用条件について詳しく説明しています。",
        url: "https://ai-consultation.netlify.app/terms",
    ...
    <div className="max-w-3xl mx-auto py-16 px-4">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-8">
        <p className="text-blue-800 text-sm">
          ...
          <br />
          <strong>次回更新予定:</strong> 2025年1月19日
        </p>
      </div>
      ...
      <p className="mb-6 text-gray-800">
        本規約の解釈にあたっては、日本法を準拠法とします。また、本規約に関して紛争が生じた場合には、東京地方裁判所を第一審の専属管轄裁判所とします。
      </p>
      ...
      <div className="mt-12 p-6 bg-gray-50 rounded-lg">
        ...
        <p className="text-gray-700 text-sm mb-3">
          当サービスでは、Google
          AdSense等の広告配信サービスを使用しています。広告の表示は、ユーザーの利用状況や興味に基づいて行われる場合があります。
        </p>
